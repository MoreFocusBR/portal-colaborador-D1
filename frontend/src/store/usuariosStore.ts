...
const useUsuariosStore = create<UsuariosState>((set, get) => ({
  ...
  fetchUsuarios: async () => {
    try {
      ...
      set({ 
        error: error instanceof Error ? error.message : 'Erro desconhecido ao buscar usuários', 
        loading: false 
      });
    }
  },
  ...
  adicionarUsuario: async (usuario) => {
    try {
      ...
      set({ 
        error: error instanceof Error ? error.message : 'Erro desconhecido ao adicionar usuário', 
        loading: false 
      });
    }
  },
  ...
  removerUsuario: async (id) => {
    try {
      ...
      set({ 
        error: error instanceof Error ? error.message : 'Erro desconhecido ao remover usuário', 
        loading: false 
      });
    }
  },
