...
const useGruposStore = create<GruposState>((set, get) => ({
  ...
  adicionarGrupo: async (grupo) => {
    try {
      ...
      set({ 
        error: error instanceof Error ? error.message : 'Erro desconhecido ao adicionar grupo', 
        loading: false 
      });
    }
  },
  ...
  atualizarGrupo: async (id, grupo) => {
    try {
      ...
      set({ 
        error: error instanceof Error ? error.message : 'Erro desconhecido ao atualizar grupo', 
        loading: false 
      });
    }
  },
  ...
  removerGrupo: async (id) => {
    try {
      ...
      set({ 
        error: error instanceof Error ? error.message : 'Erro desconhecido ao remover grupo', 
        loading: false 
      });
    }
  },
